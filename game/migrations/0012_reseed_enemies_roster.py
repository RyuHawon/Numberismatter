...
ENEMIES = [
    # Act1 — 자연
    ("들쥐", "field_rat", 12, 2, 4, 1, 1, False, 8, 14, 485),
    ("독침벌", "stinger_bee", 14, 2, 5, 1, 1, False, 8, 14, 485),
    ...
    ("마염 도롱뇽", "salamander", 24, 3, 6, 2, 1, False, 18, 28, 100),
    ("점액 군주", "ooze_king", 26, 4, 6, 2, 2, False, 20, 30, 100),
    ("롤러 스켈레톤", "skeleton_skater", 24, 3, 6, 2, 2, False, 20, 30, 100),
    ("다두묘", "hydra_cat", 28, 4, 7, 2, 3, False, 22, 34, 100),
    ("붉은 포식귀", "devourer", 30, 4, 7, 2, 3, False, 22, 34, 100),
    ("백족왕", "centipede_king", 42, 5, 8, 2, 4, True, 40, 60, 100),
    # Act3 — 지하
    ("임프", "imp", 32, 4, 7, 3, 1, False, 35, 50, 100),
    ("심연의 응시자", "gazer", 38, 5, 8, 3, 2, False, 38, 55, 100),
    ("망령거미", "wraith_spider", 42, 5, 8, 3, 3, False, 40, 58, 100),
